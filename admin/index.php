...
<body style='background-color:#4B795D;'>
<!--login form start here-->	
<h1>Administrator Account</h1>
<div class="login" style='background-color:#000;border-radius:5px;'>
	<div class="buttons">
	<h4 style='color:white;font-weight:bold;font-size:24px;'>Admin Account</h4>
